          ...
          child: Column(
            children: [
              ...
              Align(
                ...
                child: Text(
                  provider.isEnglish()
                      ? "Elgaml 2025 © All Rights Reserved"
                      : arabicNumber.convert("جميع الحقوق محفوظه © الجمل 2025"),
                  style: TextStyle(
                    fontSize: 14,
                ...
                child: Row(
                  children: [
                    Flexible(
                      ...
                      child: Text(
                        provider.isEnglish()
                            ? "Ahmed Gad Mahmoud Elgaml "
                            : "أحمد جاد محمود الجمل",
              ...
              ListTile(
                title: Text(
                  ...
                  provider.isEnglish()
                      ...
                      : "متخصص في تطوير تطبيقات الموبايل بخبرة اربع سنوات. ",
          ...
          Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.only(left: 10, right: 10),
                child: Text(
                  provider.isEnglish() ? "َIslamic" : " القرآن الكريم",
                  style: TextStyle(
                    fontSize: 24,
                    fontWeight: FontWeight.w400,
                    fontFamily: "quranFont",
          ...
          Column(
            ...
            children: [
              ...
              Slider(
                ...
                value: Provider.of<AppController>(
                  context,
                  listen: true,
                ).valueHolder.toDouble(),
                min: 14,
